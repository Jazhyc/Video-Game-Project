...
function UI:render()
    ...
    -- Syntax (Mode, Table of Vertices) Provide vertices in clockwise direction to prevent 10th dimensional horrors
    -- Health Bar
    if player.hp == 10 then
        love.graphics.polygon('fill', {10, 10, 10 * player.hp + 10, 10, 10 * player.hp, 20, 10, 20})
    elseif player.hp > 0 then
        love.graphics.polygon('fill', {10, 10, 10.75 * player.hp, 10, 10.75 * player.hp, 20, 10, 20})
    end
